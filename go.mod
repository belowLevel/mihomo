...
require (
	...
	github.com/klauspost/compress v1.18.0 // lastest version compatible with golang1.20
	...
	github.com/miekg/dns v1.1.68 // lastest version compatible with golang1.20
	github.com/mroth/weightedrand/v2 v2.1.0
	github.com/openacid/low v0.1.21
	github.com/oschwald/maxminddb-golang v1.13.1 // lastest version compatible with golang1.20
	...
	golang.org/x/crypto v0.43.0 // lastest version compatible with golang1.20
	golang.org/x/exp v0.0.0-20251017212417-90e834f514db // lastest version compatible with golang1.20
	golang.org/x/net v0.46.0 // lastest version compatible with golang1.20
	golang.org/x/sync v0.17.0 // lastest version compatible with golang1.20
	golang.org/x/sys v0.37.0 // lastest version compatible with golang1.20
	google.golang.org/protobuf v1.36.10 // lastest version compatible with golang1.20
